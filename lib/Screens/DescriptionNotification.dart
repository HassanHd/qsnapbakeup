...
class DescriptionNotification extends StatefulWidget {


  @override
  _DescriptionNotificationState createState() => _DescriptionNotificationState();
}

class _DescriptionNotificationState extends State<DescriptionNotification> {
   var id;
  // getid() async {
